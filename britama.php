...
<head>
    ...
    <title>BRI Suku Bunga | Britama</title>
    <link href="/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="#">Suku Bunga (Britama)</a>
            ...
            <div class="navbar-nav ms-auto me-3">
                ...
                <a class="nav-link active" href="/britama.php">Britama</a>
    ...
    <div class="container mt-5" style="max-width: 300px;">
        <div class="row">
            <?php 
            $query = mysqli_query($con, "SELECT * FROM suku_bunga WHERE section = 'britama'");
